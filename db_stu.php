...
setcookie("ID", $ID1, time() + (86400));//COOKIE
...
//echo $_COOKIE["ID"]; COOKIE WORKING!!
...
<!--========== SWIPER SLIDER ==========-->
        ...
        <div class="s-swiper js__swiper-one-item">
            ...
            <div class="swiper-wrapper">
                <div class="g-width-100--xs g-height-400--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/105.jpg');">
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-10--xs">
                            <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">One book, one pen, one child and one teacher<br>can change the world.</h1>
                        </div>
                       
                    </div>
                </div>
                 <div class="g-width-100--xs g-height-400--xs g-bg-position--center swiper-slide" style="background: url('img/1920x1080/102.jpg');">
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-10--xs">
                            <h1 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">A book is a dream that<br>you hold in your hands.</h1>
                        </div>
                    ...
                    <div class="container g-text-center--xs g-ver-center--xs">
                        <div class="g-margin-b-10--xs">
                            <div class="g-margin-b-30--xs">
                                <h2 class="g-font-size-35--xs g-font-size-45--sm g-font-size-55--md g-color--white">Honesty is the first chapter<br>in the book of "wisdom".</h2>
                            </div>
            ...
            <!-- End Swiper Wrapper -->
 <section>
        <div class="g-color--white-opacity-light" style="background-image: url('img/1920x1080/107.jpg');">
...
<hr>
                    <h2 class="intro-text text-center"><font color="black">Book1:
                        <strong>
                        <?php 
...
<hr>
                    <h2 class="intro-text text-center"><font color="black">Book2:
                         <strong>
                        <?php 
                         echo $row1['book2'];
?></strong></font>&nbsp &nbsp &nbsp &nbsp
...
<hr>
                    <h2 class="intro-text text-center"><font color="black">Book3:
                        <strong>
                        <?php 
                         echo $row1['book3'];
?></strong></font>&nbsp &nbsp &nbsp &nbsp
...
<hr>
                    <h2 class="intro-text text-center"><font color="black">Book4:
                        <strong>
                        <?php 
                         echo $row1['book4'];
?></strong></font>&nbsp &nbsp &nbsp &nbsp
